"""
baseline_us.py — Ultrasound-only baseline model.
...
class UltrasoundOnlyModel(nn.Module):
    """Single-stream ultrasound baseline classifier.
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        Args:
            x: Ultrasound images ``(B, 3, 224, 224)``.
    ...
    @classmethod
    def from_config(cls, config: dict) -> "UltrasoundOnlyModel":
